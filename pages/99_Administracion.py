...
# =========================
# Menú interno (tabs) y renderizadores
# =========================
...
st.divider()
st.markdown("### 🔀 Navegación del panel")
...
with t1: _render_diagnostico()
with t2: _render_jugadores()
with t3: _render_semilla()
with t4: _render_generar()
with t5: _render_fechas()
with t6: _render_publicar()
with t7: _render_resultados()
with t8: _render_eliminar()
with t9: _render_inspector()
with t10: _render_config()
