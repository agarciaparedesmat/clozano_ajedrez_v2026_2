...
/* Ajuste sutil cuando hay cabecera fija de Streamlit */
@media (min-width: 0px) {
  #admin-local-nav { top: 0; }
}
/* El radio horizontal como "segmentado" */
...
# =========================
if st.session_state.get('admin_view','📋 Resumen') == '🧾 Config':
...
# Carga de jugadores
# =========================
if st.session_state.get('admin_view','📋 Resumen') == '🧑‍🎓 Jugadores':
...
# =========================
if st.session_state.get('admin_view','📋 Resumen') == '🎲 Semilla R1':
...
# =========================
if st.session_state.get('admin_view','📋 Resumen') == '♟️ Generar':
...
# =========================
if st.session_state.get('admin_view','📋 Resumen') == '📣 Publicar':
...
# =========================
if st.session_state.get('admin_view','📋 Resumen') == '📅 Fechas':
...
# =========================
if st.session_state.get('admin_view','📋 Resumen') == '✏️ Resultados':
...
# =========================
if st.session_state.get('admin_view','📋 Resumen') == '🗑️ Eliminar':
...
# Inspector de data/
# =========================
if st.session_state.get('admin_view','📋 Resumen') == '🗂️ Archivos':
