...
# =========================
def _hide_backup_notice_now():
    # limpia el estado y marca que hay que vaciar el aviso EN ESTE MISMO RUN
    for k in ("show_backup_dl", "last_meta_backup_bytes", "last_meta_backup_name", "last_meta_backup_path"):
